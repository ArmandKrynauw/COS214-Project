...
/**
 * This class is the AbstractState of the Escalation State Design Pattern
 * Hierarchy. This state pattern is used to note the stage of the war. The stage
 * of the war may affect the mobilization of a country as a country may not
 * mobilize to a certain level at certain escalations of the war.
 */
class Escalation {
   protected:
    std::string state;
