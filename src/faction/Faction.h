...
class Mobilization;
/**
 * This class is the Component of the Faction Composite Design Pattern Hierarchy. The pattern is used
 * so that multiple countries may be stored in an alliance. Alliances may merge and be under one big alliance.
 */
class Faction {
    protected:
        std::string name;
