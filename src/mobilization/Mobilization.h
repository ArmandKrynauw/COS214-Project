...
/**
 * This class is the AbstractState for the Mobilization State Design Pattern
 * Hierarchy. This State pattern modifies countries' resources by an increase or
 * decrease depending on the mobilization state of the country.
 */
class Mobilization {
   protected:
    std::string state;
   ...
   public:
    ...
    /**
     * Provide functionality to check the current war escalation and the new
     * Mobilization of the country and set the new Mobilization of the country
     * if the escalation allows it.
     *
     ...
     */
    Mobilization* checkWarState(std::string warState,
                                std::string newMobilization);
    /**
