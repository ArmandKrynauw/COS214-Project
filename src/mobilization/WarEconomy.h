...
/**
 * This class is a ConcreteState for the Mobilization State Design Pattern
 * Hierarchy. This State modifies a countries resources by a factor of 0.6 and
 * sets the morale to -2.
 */
class WarEconomy : public Mobilization {
   public:
    ...
    /**
     * Provide functionality to get the industry modifier of this state as a
     * percentage
     *
