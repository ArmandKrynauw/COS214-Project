...
/**
 * This class is used to by different countries to house troops, assign
 * strategies and have battle between each country in different zones. Each
 * theatre has resources which a country needs to progress in the war. Countries
 * fight in theatres to obtain more control for more resources and ultimately to
 * win the war.
 */
class Theatre {
   private:
    ...
    /**
     * Provides functionality to get the percentage control of a faction in this
     * theatre
     *
     * @param faction Name of the faction whose percentage control needs to be
     * returned
    ...
    /**
     * Provides functionality to get the percentage control that all other
     * factions have in this theatre
     *
   ...
   public:
    ...
    void battle();
    /**
     * Provides functionality to get percentage of resources a faction will
     * receive.
     *
     * @param faction Name of the faction whose resources portion needs to be
     * returned
     * @return Portion of resource given to the faction
     */
    int getResource(std::string faction);
    /**
     * Provides functionality to display the internals of a theatre. This being
     * troop count per faction and theatre name.
     *
     */
    void printTheatre();
    /**
    ...
    /**
     * Provides functionality to display the strategies that each faction
     * currently executes
     */
    void printStrategies();
    /**
     * Provides functionality to return a json object containing data of the
     * theatre
     *
    ...
    /**
     * Provides functionality to return the strategy for a given faction in
     * string format. (e.g. If AttackStrategy object then return "Attack
     * Strategy")
     *
    ...
    /**
     * Provides functionality to check if a faction has given a strategy for the
     * theatre.
     *
    ...
    /**
     * Provides functionality to provide the target for the strategy in the
     * theatre for the passed in faction.
     *
