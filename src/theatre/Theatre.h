...
/**
 * This class is used to by different countries to house troops, assign strategies and have battle between each country
 * in different zones. Each theatre has resources which a country needs to progress in the war. Countries fight in theatres
 * to obtain more control for more resources and ultimately to win the war.
 */
class Theatre {
    private:
        std::string name;
