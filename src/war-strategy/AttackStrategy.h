 ...
 * This state is used if a country wants to attack on a battle day. If the
 * current attack strategy was planned a country will have 1.5 times more damage
 * else the country will have the normal damage.
 */
